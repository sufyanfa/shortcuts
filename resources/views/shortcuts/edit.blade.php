                        ...
                        <div class="card-body">
                                <form class="form" action="/shortcuts/{{ $shortcut->id }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label> العنوان: </label>
                                        <input class="form-control @error('title') is-invalid @enderror" type="name" :value="{{ old('title') }}" value="{{ $shortcut->title }}" name="title">
                                            @error('title')
                                    ...
                                    <div class="form-group">
                                        <label> الرابط: </label>
                                        <input class="form-control @error('url') is-invalid @enderror" type="name" :value="{{ old('url') }}" value="{{ $shortcut->url }}" name="url">
                                        @error('url')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="name" name="icon"><br>
                                    </div>
                                    -->


                                    <div class="form-group">
                                        <label for="icon"> الايقونه: </label>
                                        <select class="form-control" id="icon" name="icon">
                                        <option value="fas fa-align-left">&#xf036; fa-align-left</option>
                                        <option value="fas fa-align-right">&#xf038; fa-align-right</option>
                                        <option value="fab fa-amazon">&#xf270; fa-amazon</option>
                                        <option value="fas fa-ambulance">&#xf0f9; fa-ambulance</option>
                                        <option value="fas fa-anchor">&#xf13d; fa-anchor</option>
                                        <option value="fab fa-android">&#xf17b; fa-android</option>
                                        <option value="fab fa-angellist">&#xf209; fa-angellist</option>
                                        ...
                                        <option value="fab fa-apple">&#xf179; fa-apple</option>
                                        ...
                                        <option value="fab fa-behance-square">&#xf1b5; fa-behance-square</option>
                                        ...
                                        <option value="fab fa-bitbucket-square">&#xf172; fa-bitbucket-square</option>
                                        <option value="fab fa-bitcoin">&#xf15a; fa-bitcoin</option>
                                    ...
                                    <div class="form-group" style="margin-top: 20px;">
                                        <label> اللون : </label>
                                        <input type="color" name="color" value="#e66465" style="width: 90px;"><br>
                                    </div>
                                -->
                                <div class="form-group" style="margin-top: 20px;">
                                    <label> اللون : </label>
                                    <div class="select-colors" style="text-align: center">
                                        ...
                                        <input type="radio" id="ff8367" name="color" value="#ff8367"  data-color="#ff8367"/>
                                        <label class="label-color" for="ff8367" /></label>
                                        <input type="radio" id="f8a650" name="color" value="#f8a650"  data-color="#f8a650"/>
                                        <label class="label-color" for="f8a650" /></label>
                                        <input type="radio" id="edc501" name="color" value="#edc501"  data-color="#edc501"/>
                                        <label class="label-color" for="edc501" /></label>
                                        <input type="radio" id="green" name="color" value="#46c961"  data-color="#46c961"/>
                                        <label class="label-color" for="green" /></label>
                                        <br>
                                        <input type="radio" id="greens" name="color" value="#02cfb0" data-color="#02cfb0"/>
                                        <label class="label-color" for="greens" /></label>
                                        <input type="radio" id="blue" name="color" value="#01cade"  data-color="#01cade"/>
                                        <label class="label-color" for="blue" /></label>
                                        <input type="radio" id="blus" name="color" value="#00b3f6"  data-color="#00b3f6"/>
                                        <label class="label-color" for="blus" /></label>
                                        <input type="radio" id="blues" name="color" value="#496ac9"  data-color="#496ac9"/>
                                        <label class="label-color" for="blues" /></label>
                                        <input type="radio" id="pinkr" name="color" value="#8452c3"  data-color="#8452c3"/>
                                        <label class="label-color" for="pinkr" /></label>
                                        <br>
                                        <input type="radio" id="pinks" name="color" value="#b97ae3" data-color="#b97ae3"/>
                                        <label class="label-color" for="pinks" /></label>
                                        <input type="radio" id="pinkz" name="color" value="#f58ed5"  data-color="#f58ed5"/>
                                        <label class="label-color" for="pinkz" /></label>
                                        <input type="radio" id="gry" name="color" value="#86909c"  data-color="#86909c"/>
                                        <label class="label-color" for="gry" /></label>
                                        <input type="radio" id="grys" name="color" value="#939e96"  data-color="#939e96"/>
                                        <label class="label-color" for="grys" /></label>
                                        <input type="radio" id="gryz" name="color" value="#9d928c"  data-color="#9d928c"/>
                                        <label class="label-color" for="gryz" /></label>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <label> وصف الاختصار: </label>
                                        <textarea class="form-control" name="body">{{ $shortcut->body }}</textarea>
                                    </div>
